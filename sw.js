    ...
    caches
      ...
      .then(function (cache) {
        cache.addAll([
          ...
          '/jspm_packages/github/angular/bower-angular@1.3.15.js',
          '/jspm_packages/github/angular/bower-angular@1.3.15/angular.js',

          '/jspm_packages/github/angular-ui/ui-router@0.2.13.js',
          '/jspm_packages/github/angular-ui/ui-router@0.2.13/angular-ui-router.js',

          '/jspm_packages/github/jspm/nodelibs-process@0.1.1.js',
          '/jspm_packages/github/jspm/nodelibs-process@0.1.1/index.js',

          '/jspm_packages/github/firebase/firebase-bower@2.2.3.js',
          '/jspm_packages/github/firebase/firebase-bower@2.2.3/firebase.js',

          '/jspm_packages/github/systemjs/plugin-text@0.0.2.js',
          '/jspm_packages/github/systemjs/plugin-text@0.0.2/text.js',

          '/jspm_packages/npm/process@0.10.1/browser.js',
          '/jspm_packages/npm/lodash@3.5.0.js',
          '/jspm_packages/npm/lodash@3.5.0/index.js',
...
function firebaseDataResponse(request) {
  ...
  if (request.method === 'GET') {
    ...
    return Promise.all([
      caches.open(DATA_CACHE_KEY),
      request.json()
    ]).then(function (val) {
      var cache = val[0];
      var data = val[1];
      return cache.put(getResquest,
...
function normalize(url) { return BASE_URL + url; }
