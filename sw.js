System.register([], function (_export) {
  var SW_VERSION, BASE_URL, STATIC_CACHE_KEY, DATA_CACHE_KEY, IMAGE_CACHE_KEY;
  ...
  return {
    ...
    execute: function () {
      ...
      SW_VERSION = "0.9.0";
      BASE_URL = "";
      STATIC_CACHE_KEY = "odif-static-" + SW_VERSION;
      DATA_CACHE_KEY = "odif-data-" + SW_VERSION;
      IMAGE_CACHE_KEY = "odif-img-" + SW_VERSION;
